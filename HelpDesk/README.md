flowchart TD
    ...
    0 --> 22["ChatSession 생성<br/>(session_id, messages={role='user', content})"]:::mongodb
    22 --> 23["ChatSession 저장"]:::mongodb
    
    23 --> 24["에이전트 시작"]:::agent
    24 --> 25["카테고리 및 키워드 추출<br/>category='ex', keywords=['ex']"]:::agent
    ...
    60 --> 65["category, message 추가<br/>(session_id, category, messages={role='tool', content})"]:::mongodb
    ...
    130 --> 140["category, message 추가<br/>(session_id, category, messages={role='tool', content})"]:::mongodb
